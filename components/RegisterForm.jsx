...
import { useFormState, useFormStatus } from "react-dom"; // this will be used to get the current state and status of the form

import { register } from "../actions/userController";

export default function RegisterForm() {
  const [formState, formStatus] = useFormState(register, {}); // get the current state and status of the form
